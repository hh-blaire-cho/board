package com.fastcampus.board.util;
...
@DisplayName("Test Util - Form Data Encoder")
...
class FormDataEncoderTest {
    ...
    @DisplayName("객체를 넣으면, url encoding 된 form body data string return")
    @Test
    void test_formDataEncoding() {
        // Given object
        // When encoding it
        // Then should return form-body-data-style encoded string
