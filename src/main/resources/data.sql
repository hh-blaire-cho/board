...
('rhkwk3333', 'asdf2063', 'Jung', 'rhkwk@mail.com', 'Memo1', now(), 'rhkwk3333', now(), 'rhkwk3333');
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
('iady7777', 'qwerty', 'Blaire', 'iady7777@mail.com', 'Memo2', now(), 'iady7777', now(), 'iady7777');
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at, modified_by) values
('iamysd629', 'password', 'Umma', 'iamysd@mail.com', 'Memo3', now(), 'iamysd629', now(), 'iamysd629');
