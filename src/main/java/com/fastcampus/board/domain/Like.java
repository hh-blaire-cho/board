...
public class Like {
    ...
    public static Like createForArticle(UserAccount userAccount, Article article) {
    ...
    public static Like createForComment(UserAccount userAccount, Comment comment) {
